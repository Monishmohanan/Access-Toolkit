...
class Application(object):
    def __init__(self, master):
        ...
        for key, value in Buttons.items():
            ttk.Button(master, text = key,style = 'my.TButton',                        command = partial(self.run, key)).pack( fill = BOTH, expand = True)
    def run(self, value):
...
class Settings(Application):
    def __init__(self, master):
        ...
        Label(master, text = 'Configured Buttons', font = ('helvetica 15 bold'),              bg = '#9B240A', fg = 'white').place(x = 150, y = 5)
        Frame(
                master, width = 490, 
        ...
        Frame(
                ...
                bg = 'white').pack()
        Label(master, text = "Window Resizing", font = ('helvetica 15 bold'),              bg = "#9B240A", fg = 'white').place(x = 150, y = 215)
        Label(
                master, text = "Width: ", 
